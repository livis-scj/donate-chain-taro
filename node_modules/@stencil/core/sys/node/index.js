...
const fs = _interopDefault(require("./graceful-fs.js")), path = _interopDefault(require("path")), util = require("util"), glob = _interopDefault(require("./glob.js")), os = require("os"), crypto = require("crypto"), cp = require("child_process"), events = require("events"), createTerminalLogger = e => {
  ...
  const s = [], n = e => {
  ...
  }, c = t => e.color(t, "red"), u = t => e.color(t, "yellow"), h = t => e.color(t, "cyan"), d = t => e.color(t, "bold"), p = t => e.color(t, "dim"), m = t => e.color(t, "bgRed"), g = e => LOG_LEVELS.indexOf(e) >= LOG_LEVELS.indexOf(t), f = (t, r, s) => {
    var n, o;
    ...
    for (n = 0; n < l; n++) o = t.charAt(n), n >= r && n < r + s && (o = m("" === o ? " " : o)), 
    a.push(o);
    return a.join("");
    ...
    createTimeSpan: (t, r = !1, s) => {
      const o = Date.now(), i = () => Date.now() - o, c = {
        ...
        finish: (t, o, c, u) => {
          const h = i();
          let m;
          return m = h > 1e3 ? "in " + (h / 1e3).toFixed(2) + " s" : parseFloat(h.toFixed(3)) > 0 ? "in " + h + " ms" : "in less than 1 ms", 
          ((t, r, s, o, i, c, u) => {
            let h = t;
      ...
      r.forEach(r => {
        l = l.concat(((r, s) => {
          ...
          r.lines && r.lines.length && (prepareLines(r.lines).forEach(e => {
            ...
            let s = e.text;
            e.errorCharStart > -1 && (s = f(s, e.errorCharStart, e.errorLength)), t = p(t), 
